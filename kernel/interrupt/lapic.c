...
static inline void lapic_write(paddr_t base, u64 off, u64 size, u64 cont) {
  ...
  case 4: *(u32 *)((void *)base + off) = (u32)cont; break;
  case 8: *(u64 *)((void *)base + off) = (u64)cont; break;
  default: kerror("[lapic_write] Invalid param!\n"); ABORT();
  }
...
static inline u64 lapic_read(paddr_t base, u64 off, u64 size) {
  ...
  case 4: return *(u32 *)((void *)base + off);
  case 8: return *(u64 *)((void *)base + off);
  default: kerror("[lapic_read] Invalid param!\n"); ABORT();
  }
}
